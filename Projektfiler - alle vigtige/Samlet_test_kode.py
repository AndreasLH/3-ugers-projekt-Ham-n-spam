...
""" Program Describtion:
    ...
    4. https://scikit-learn.org/stable/modules/generated/sklearn.feature_extraction.text.TfidfVectorizer.html (TfidfVectorizer)
...
#                      -----  Mission Control  -----                          #
###############################################################################
filename = 'processed_emails_v1B.csv'
...
TFIDF_max_features = 15        # None or int 
...
for iteration in range(iterations):
    ...
    if TFIDF_max_features <= 15:
        ...
        print("Feature vocabulary: To many features")
