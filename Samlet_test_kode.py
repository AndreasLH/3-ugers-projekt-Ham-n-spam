...
#                      -----  Mission Control  -----                          #
###############################################################################
filename = 'processed_emails2.csv'
...
# Matrix for results (document classification x test)
predicted_matrix = np.zeros((iterations + 1))
true_matrix = np.zeros((iterations + 1))
...
5. Der er noget helt galt med vores data eller kode ()
"""
